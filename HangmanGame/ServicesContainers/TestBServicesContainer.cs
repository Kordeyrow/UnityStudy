...
namespace CSharpConsoleHangmanGame.ServicesContainers
{
    internal class TestBServicesContainer : IServicesContainer
    {
        ...
        public IInputOptionsKeys InputOptionsKeys { get; private set; }
        ...
        public async Task Init()
        {
            ...
            DialogueDatabase = new CloudCSVDialogueDatabase(Configs.DialogueDatabaseURL, DialogueUnitKeys);
            await DialogueDatabase.Init();

            InputOptionsKeys = new NumberInputOptionsKeys();
            DialogueController = new ConsoleDialogueController();
            InitialGameState = new MenuState(DebugLog, DialogueController, DialogueDatabase, InputOptionsKeys, Configs);
